...
class CategoryItems extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: ResponsiveLayout_(desktopBody: TbletGridView(leng: leng, data: data,),
        mobileBody: MobileGridView(leng: leng, data: data,),),//test(image: data[index].cover, data: data[index]) ,)
      );
  }
}
