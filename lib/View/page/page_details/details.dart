...
class Details extends StatefulWidget {
  ...
  Details({required this.data, this.showList = false});
...
class _DetailsState extends State<Details> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(right: 20.w, left: 20.w, bottom: 5),
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext ctx, index) {
                              return Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: SvgPicture.asset(
                                    widget.AdditionalAbilities[index]
                                        .toString(),
                                    width: 25,
                                    height: 25,
                                    color: Colors.blue),
                      ...
                      Container(
                        ...
                        child: Stack(
                          children: [
                            Container(
                                alignment:
                                    lengage == "France" || lengage == "English"
                                        ? Alignment.topLeft
                                        : Alignment.topRight,
  ...
  Widget BuldeIndector() => AnimatedSmoothIndicator(
        count: widget.idAnonnce == null
            ? widget.data.cover.length
  ...
  abilitycompre() {
    ...
    for (int j = 0; j < widget.iconability!.length; j++) {
      for (int i = 0; i < ListAbility.length; i++) {
        if (ListAbility[i].icon.split('/')[2] ==
                "${widget.iconability![j]}.svg" &&
            ListAbility[i].type == "main") {
          widget.MainAbilities.add(ListAbility[i].icon);

        } else if (ListAbility[i].icon.split('/')[2] ==
                "${widget.iconability![j]}.svg" &&
            ListAbility[i].type == "additional") {
          widget.AdditionalAbilities.add(ListAbility[i].icon);
        } else if (ListAbility[i].icon.split('/')[2] ==
                "${widget.iconability![j]}.svg" &&
            ListAbility[i].type == "inner") {
