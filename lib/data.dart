...
List<Category> dataCategory = [
  Category(icon: "assets/icon/annonces/home.svg", name:"All"),
  ...
  Category(icon: "assets/icon/annonces/villa.svg", name: 'villa'),
  Category(icon: "assets/icon/annonces/farm.svg", name: 'farm'),
